...
docs/        the website itself, and the folder GitHub Pages serves
  ...
  img/         hero photographs, if you add any; see img/README.md
```

Each page except the map opens with a header: the words on the left, and on the
right a picture of the dataset itself, one small cell per comparison, teal for a
decrease and pink for an increase. Different pages band the cells differently,
by outcome, practice, country or source. To use a photograph on a page instead,
